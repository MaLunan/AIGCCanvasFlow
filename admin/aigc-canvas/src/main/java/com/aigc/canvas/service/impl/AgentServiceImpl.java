...
public class AgentServiceImpl implements AgentService {
    ...
    /**
     * 提交生图/生视频任务（异步）
     * 流程：用户选择的模型库 ID → 解析为 LangChain 模型标识 → 提交任务 → 返回 taskId
